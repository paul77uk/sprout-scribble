...
// delete cascade: when a product is deleted, all variants associated with it are also deleted
...
export const orderRelations = relations(orders, ({ one, many }) => ({
  ...
  orderProducts: many(orderProduct, { relationName: "orderProduct" }),
}));
